			...
			<main className='max-w-7xl mx-auto py-6 px-4 lg:px-8'>
				...
				>
					<StatCard
						...
						color='#6366F1'
					/>
					<StatCard name='New Users Today' icon={UserPlus} value={collegeStats.newCollegeToday} color='#10B981' />
					<StatCard
						name='Active Users'
						icon={UserCheck}
						...
						color='#F59E0B'
					/>
					<StatCard name='Churn Rate' icon={UserX} value={collegeStats.churnRate} color='#EF4444' />
				</motion.div>
